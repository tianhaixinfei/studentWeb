...
/* 会议纪要 */
Ext.ux.form.HtmlEditor.Add_Button_Summary = Ext.extend(Ext.util.Observable, {
    init: function(cmp){
        this.cmp = cmp;
        this.cmp.on('render', this.onRender, this);
    },
    ...
    onRender: function(){
		...
		var btn = this.cmp.getToolbar().addButton({
			...
			text:'导入附件',
			handler : function() {
					uploadSchemeWin('uploadSchemeWin_Summary');
			}
		});
    }
});
...
/* 专家意见 */
Ext.ux.form.HtmlEditor.Add_Button_Idea = Ext.extend(Ext.util.Observable, {
    init: function(cmp){
        this.cmp = cmp;
        this.cmp.on('render', this.onRender, this);
    },
    ...
    onRender: function(){
		...
		var btn = this.cmp.getToolbar().addButton({
			...
			text:'导入附件',
			handler : function() {
					uploadSchemeWin('uploadSchemeWin_Idea');
			}
		});
    }
});
