...
window.FlexPaperViewer = window.$f = function() {
	...
	window.FlexPaperViewer_Instance = flashembed(arguments[1], {
			src: "/DEP/resources/jslib/pdfViewer/"+arguments[0]+".swf",
			version: [10, 0],
	...
	var f = extend(window.flashembed, {
		...
		getHTML: function(opts, conf) {
			...
			if (opts.w3c || IE) {
				...
				//html += '<embed src="' +opts.src+ '" WMODE="transparent" quality="high"   allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />';				
			}
